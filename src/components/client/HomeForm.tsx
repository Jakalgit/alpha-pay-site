...
import styles from "@/styles/components/client/HomeForm.module.css"
	...
	return (
		<div
			...
			className={`absolute z-10 flex flex-col justify-between ${styles.startForm} bg-[color:--purple-color-3] 
                !border border-[color:--gold-color-2]`}
		>
			<h3 className={`geologica text-[color:--gold-color-1] font-semibold text-center ${styles.formName}`}>
				{t("section2.formName")}
			</h3>
			<div className={`flex ${styles.inputs}`}>
				...
				<button
					...
					className={`flex items-center justify-center geologica bg-[color:--gold-color-1] hover:brightness-[85%] duration-300 transition-all
