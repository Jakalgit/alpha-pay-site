...
import styles from "@/styles/components/client/adavntages-block/Geo.module.css"
...
const Geo: React.FC<GeoProps> = ({ isoCodes }) => {
	...
	return (
		<div className={`flex flex-col bg-[color:--purple-color-3] ${stylesBlock.descriptionBlock} ${styles.block}`}>
								...
								return (
									<React.Fragment key={geo.rsmKey}>
										<Geography
											geography={geo}
											style={{
												default: { fill: isInclude ? "var(--gold-color-1)" : "var(--purple-color-5)" , stroke: "#FFF", strokeWidth: 0.75 },
