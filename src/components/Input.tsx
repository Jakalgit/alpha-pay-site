...
const Input: React.FC<InputProps> = ({ wrapperAttributes, inputAttributes }) => {
	...
	return (
		<div
			{...wrapperAttributes}
			className={`flex items-center !border border-[color:--gold-color-2] ${styles.wrapper} ${wrapperClassName}`}
		>
			<input
				{...inputAttributes}
				className={`geologica w-full text-[color:--purple-color-1] placeholder-[--color:--purple-color-4] 
